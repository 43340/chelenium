...
class CreateAccPage(PageElement):
    ...
    def fill_up_form(self, data):
        ...
        actions.update_text(self.email, (data.get("email")))
        ...
        actions.update_text(self.first_name_02, (data.get("first_name_02")))
        actions.update_text(self.last_name_02, (data.get("last_name_02")))
